...
class MeasurementConfigDialog(QDialog):
    def __init__(self, current_duration: int, current_rate_hz: float, parent=None):
        ...
        self.setStyleSheet("""
            ...
            /* Enhanced styling block for precision adjustment widgets */
            QSpinBox { 
        ...
        # Abstract the underlying sampling frequency into an intuitive discrete time interval mapping
    ...
    def _validate_inputs(self):
        ...
        # Dynamically lock form submission if constraints are violated
        if error_msgs:
    ...
    def get_values(self):
        # Convert the user-friendly temporal interval back to a hardware-compliant frequency target
