...
# Core utilities designated for uniform nomenclature decoding
...
class SensorConfigDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        # Enumerate and generate interactive boolean controls for each discovered peripheral
    ...
    def get_allowed_sensors(self) -> Set[str]:
        # Compile a runtime set of selected constraints based on user interaction
        allowed = set()
