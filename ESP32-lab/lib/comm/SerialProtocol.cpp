...
void SerialProtocol::sendHello(bool bme_ok, uint8_t dallas_count, bool adc_ok, bool tmp_ok, bool pt1000_ok) {
    ...
    Serial.print(tmp_ok?"true":"false"); 
    Serial.print(",\"pt1000\":"); Serial.print(pt1000_ok?"true":"false");
...
void SerialProtocol::sendData(uint32_t t_ms, float t_tmp, float t_bme, float h_bme, DallasBus& dallas, float v1, float v2, float v3, float v4, float v_pt1000, float t_pt1000) {
    ...
    Serial.print(",\"H_BME\":"); if(isnan(h_bme)) Serial.print("null"); else Serial.print(h_bme, 4);
    ...
    Serial.print(",\"V_PT1000\":"); Serial.print(v_pt1000, 4);
    Serial.print(",\"T_PT1000\":"); if(isnan(t_pt1000)) Serial.print("null"); else Serial.print(t_pt1000, 4);
